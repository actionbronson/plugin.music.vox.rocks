...
class VoxOAuthLogin(object):
    def __init__(self, oauth_provider: OAuthProvider, client_id: str, client_secret: str) -> None:
    ...
    def login(self, username: str, password: str):
        ...
        try:
            ...
            xbmc.log(f"Could not obtain VOX Premium code with client_id: {self.client_id}.  Check subscription.", xbmc.LOGERROR)
            raise e
        ...
        try:
            ...
            xbmc.log(f"Obtained oauth_token_resp: {self.vox_oauth_bearer_token}", xbmc.LOGINFO)
